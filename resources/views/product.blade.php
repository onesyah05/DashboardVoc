          ...
          <div class="card-header bg-transparent">
            <div class="row align-items-center">
              <div class="col">
                ...
                <h5 class="h3 text-white mb-0">Add Product</h5>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form action="/postProduct" method="post">
                ...
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Kode Product</label>
                    <input class="form-control" name="kode" type="text" id="example-text-input">
                </div>
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Nama Product</label>
