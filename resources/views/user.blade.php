          ...
          <div class="card-header bg-transparent">
            <div class="row align-items-center">
              <div class="col">
                ...
                <h5 class="h3 text-white mb-0">Add User</h5>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form action="/postUser" method="post">
                ...
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">User Untuk</label>
                    <select name="code" class="form-control" id="">
                        <option class="form-control" value="">-- Pilih User untuk --</option>
                        <option class="form-control" value="1">Super Admin</option>
                        <option class="form-control" value="2">Admin</option>
                        @foreach ($resel as $key)
                        <option class="form-control" value="{{$key->koderesel}}">{{$key->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Nama User</label>
                    <input class="form-control" name="name" type="text" id="example-text-input">
                </div>
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Email User</label>
                    <input class="form-control" name="email" type="email" id="example-text-input">
                </div>
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Password</label>
