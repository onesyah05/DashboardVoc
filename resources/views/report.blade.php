          ...
          <div class="card-header bg-transparent">
            <div class="row align-items-center">
              <div class="col">
                ...
                <h5 class="h3 text-white mb-0">Masukkan Laporan</h5>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form action="/postReport" method="POST">
                ...
                <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-light">Sisa Produk</label>
                    <input class="form-control" name="sisa" type="number" id="example-text-input">
                </div>
